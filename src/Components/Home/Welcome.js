...
export class Welcome extends Component{
    render() {
      return (   
        <div class="bg-white  w-screen min-h-screen max-h-full bg-[url('Resources/Images/NMSU_2.jpg')] bg-no-repeat bg-cover p-10 pt-20  items-center justify-center sm:p-10" >
