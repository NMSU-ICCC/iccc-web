...
export class Repository extends Component{
    render() {
      return (   
        ...
        // <div class="bg-slate-600 w-full h-fit mx-20 shadow-xl text-white font-bold p-10">
        //     <p>Most of our projects are stores in git</p>
        //     <p>Many of them are also public</p>
        //     <GeneralButton name="Github" link ="https://github.com/NMSU-ICCC/iccc-website"/>
        //     <a href='https://github.com/NMSU-ICCC/iccc-website'> To see them, click here! (GitHub)</a>
        //     <p>If you don't have access to the repository you wish to see,  and you think you should have access, or 
        //         want to work with us in that project, contact a club's officer and ask for help</p>
        // </div>   
      );
    }
  }
